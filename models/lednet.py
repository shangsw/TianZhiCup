...
class Encoder(nn.Module):
    def __init__(self, num_classes, channels):
        super().__init__()
        self.initial_block = DownsamplerBlock(channels, 32)
        # for 1 channel
...
class Decoder(nn.Module):
    def __init__(self, num_classes):
        ...
        self.apn = APN_Module(in_ch=128, out_ch=5)
    ...
    def forward(self, input):
        ...
        # print(input.shape,output.shape,'44444444444444444')
...
# LEDNet
class Net(nn.Module):
    def __init__(self, num_classes, channels, encoder=None):
        super().__init__()
